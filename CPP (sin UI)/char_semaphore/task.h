...
public:
    ...
    static vector<vector<char>> currentGrid; /**< Cuadrícula actual de la simulación. */
    static vector<vector<char>> nextGrid; /**< Cuadrícula siguiente de la simulación. */
     ...
     */
    static void setSimulationParameters(int size, int generations, vector<vector<char>> currentGrid, vector<vector<char>> nextGrid, int cell_proliferation_potential_max, float chance_spontaneous_death, int chance_proliferation, int chance_STC_creation, int chance_migration, bool starter_cell_is_STC);
     ...
     */
    void printGrid(vector<vector<char>> grid, int iteration, int numThreads);
